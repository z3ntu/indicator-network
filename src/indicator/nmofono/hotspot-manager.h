...
class HotspotManager : public QObject
{
    ...
    Q_PROPERTY( bool knownBadHardware
        READ knownBadHardware
        NOTIFY knownBadHardwareChanged)
...
Q_SIGNALS:
    ...
    void knownBadHardwareChanged(bool knownBadHardware);
