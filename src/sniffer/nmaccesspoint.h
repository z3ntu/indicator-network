...
#ifndef NMACCESSPOINT_H_1416391263
#define NMACCESSPOINT_H_1416391263
 ...
 */
class NetworkManagerAccessPoint: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    NetworkManagerAccessPoint(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
