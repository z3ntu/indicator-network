...
#ifndef NMACTIVECONNECTION_H_1416389726
#define NMACTIVECONNECTION_H_1416389726
 ...
 */
class NetworkManagerActiveConnection: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    NetworkManagerActiveConnection(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
